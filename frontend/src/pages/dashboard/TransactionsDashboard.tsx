    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-[var(--foreground-muted)] mt-1">View and manage all financial transactions</p>
        </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-[var(--glass-border)]">
                  ...
                  <th className="text-left py-3 px-4 text-sm font-semibold text-[var(--foreground)]">Amount</th>
                  ...
                  <th className="text-left py-3 px-4 text-sm font-semibold text-[var(--foreground)]">Type</th>
                </tr>
              </thead>
              <tbody>
                {recentTransactions.map((transaction) => (
                  <tr key={transaction.id} className="border-b border-[var(--glass-border)] hover:bg-[var(--card-hover)]">
                    <td className="py-4 px-4 text-sm font-mono text-[var(--foreground)]">{transaction.id}</td>
                    <td className="py-4 px-4 text-sm text-[var(--foreground)]">{transaction.description}</td>
                    <td className="py-4 px-4 text-sm font-semibold text-[var(--foreground)]">{transaction.amount}</td>
                    ...
                    <td className="py-4 px-4 text-sm text-[var(--foreground-muted)]">{transaction.date}</td>
                    <td className="py-4 px-4">
