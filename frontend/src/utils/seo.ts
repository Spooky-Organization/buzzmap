...
export const SEO_CONFIG = {
  ...
  github: 'https://github.com/Matthew-kabiu/Authentication-Template.git',
...
export const PAGE_SEO: Record<string, PageSEO> = {
  '/': {
    title: 'Production-Ready Authentication Template | Secure JWT, MFA, RBAC',
  ...
  '/login': {
    title: 'Login | Authentication Template',
  ...
  '/register': {
    title: 'Create Account | Authentication Template',
  ...
  '/forgot-password': {
    title: 'Forgot Password | Authentication Template',
  ...
  '/terms': {
    title: 'Terms and Conditions | Authentication Template',
    description: 'Read our terms and conditions for using the Authentication Template.',
    keywords: 'terms and conditions, terms of service, legal',
    noindex: false,
  },
  '/privacy': {
    title: 'Privacy Policy | Authentication Template',
    description: 'Learn how we protect your privacy and handle your data.',
    keywords: 'privacy policy, data protection, privacy',
    noindex: false,
  },
  '/dashboard': {
    title: 'Dashboard | Authentication Template',
