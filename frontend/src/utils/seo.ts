...
export const PAGE_SEO: Record<string, PageSEO> = {
  '/': {
    title: 'BuzzMap | Trust-Driven Social Marketplace',
  ...
  '/terms': {
    title: 'Terms and Conditions | BuzzMap',
    description: 'Read our terms and conditions for using the BuzzMap.',
    keywords: 'terms and conditions, terms of service, legal',
    noindex: false,
  },
  '/privacy': {
    title: 'Privacy Policy | BuzzMap',
    description: 'Learn how we protect your privacy and handle your data.',
    keywords: 'privacy policy, data protection, privacy',
    noindex: false,
  },
  '/dashboard': {
    title: 'Dashboard | BuzzMap',
