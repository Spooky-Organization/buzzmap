...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center justify-between rounded-lg glass-input px-3 py-2 text-sm',
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        'bg-[var(--background-secondary)] border border-[var(--glass-border)] shadow-glass backdrop-blur-xl',
        'text-[var(--foreground)]',
